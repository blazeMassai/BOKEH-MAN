...
def starter(request):
    plot = figure()
    plot.circle([1, 10, 35,  27], [0, 0, 0, 0], size=15, color= "blue")

    script, div = components(plot)

    return render(request, 'bokehApp/starter.html' , {'script': script, 'div':div})
...
def home(request):
    ...
    return render(request, 'bokehApp/home.html' , {'script': script, 'div':div})
...
def combo(request):
    ...
    return render(request, 'bokehApp/combo.html' , {'script': script, 'div':div})
...
def programming(request):
    ...
    return render(request, 'bokehApp/programming.html' , {'script': script, 'div':div})
...
def multi_plot(request):
    ...
    return render(request, 'bokehApp/multi_plot.html' , {'script': script, 'div':div})
...
def products(request):
    ...
    return render(request, 'bokehApp/products.html' , {'script': script, 'div':div})
...
def pie(request):
    ...
    p.wedge(x=0, y=1, radius=0.4,
            ...
            line_color="royalblue", fill_color='color', legend_label='country', source=data)


    script, div = components(p)

    return render(request, 'bokehApp/pie.html' , {'script': script, 'div':div})